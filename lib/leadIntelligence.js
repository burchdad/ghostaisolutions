...
export async function generateOutreachDraft(lead) {
  ...
  const fallbackBody = [
    ...
    "",
    "If useful, I can share a short 1-page teardown with 2-3 concrete opportunities specific to your stack.",
    "",
    "Best,",
    senderName,
    senderRole,
...
- Avoid links, attachments, emojis, and marketing buzzwords.
- Use a soft CTA that asks permission for a short teardown/audit.
