  ...
  return (
    <section className="py-20">
      ...
      <Breadcrumbs />
        ...
        const url = `https://ghostai.solutions/blog/${post.slug}`;
const blogJsonLd = {
  ...
  publisher: { "@type": "Organization", name: "Ghost AI Solutions", logo: { "@type":"ImageObject", url:"https://ghostai.solutions/logo.png" } },
  url
};
