...
export default function FAQ() {
  const faqs = [
    [
      "What is an AI agent?",
      "Software that can perceive input, reason with context, and act in your tools with safeguards.",
    ],
    [
      "How do you keep data safe?",
      "Least‑privilege access, encryption, audit logs, human‑in‑the‑loop for critical actions, and vendor due‑diligence.",
    ],
    [
      "When do we see results?",
      "Most teams see measurable impact in 2–4 weeks after discovery, starting with 1–2 high‑ROI workflows.",
    ],
  ];
